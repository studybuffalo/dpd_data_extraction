...
def unzip_zips(suffixList, date, fileList):
    # Create the folder to hold the data extracts
    zipsLocation = root.child("dpd_data_extracts", date)
    ...
    for suffix in suffixList:
        ...
        zipPath  = zipsLocation.child(zipName).absolute()
        ...
        for fileName in fileList:
            ...
            archive.extract(fileName, path=zipsLocation.absolute())
...
unzip_zips(suffixList, today, fileList)
